            ...
            <div class="col">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{route('doctors.update', ['doctor' => $medecin->id])}}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('tel') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="tel" id="input-tel" class="form-control form-control-alternative{{ $errors->has('tel') ? ' is-invalid' : '' }}" placeholder="{{ __('Télephone') }}" value={{$medecin->tel}} required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('nom') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="nom" id="input-nom" class="form-control form-control-alternative{{ $errors->has('nom') ? ' is-invalid' : '' }}" placeholder="{{ __('Nom') }}" value={{$medecin->nom}} required>
                                ...
                                <div class="form-group{{ $errors->has('prenom') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="prenom" id="input-prenom" class="form-control form-control-alternative{{ $errors->has('prenom') ? ' is-invalid' : '' }}" placeholder="{{ __('Prénom') }}" value={{$medecin->prenom}} required>
                                ...
                                <div class="form-group{{ $errors->has('adresse') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="adresse" id="input-adresse" class="form-control form-control-alternative{{ $errors->has('adresse') ? ' is-invalid' : '' }}" placeholder="{{ __('Adresse') }}" value={{$medecin->adresse}} required>
                                ...
                                <div class="form-group{{ $errors->has('ville') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="ville" id="input-email" class="form-control form-control-alternative{{ $errors->has('ville') ? ' is-invalid' : '' }}" placeholder="{{ __('Ville') }}" value={{$medecin->ville}} required>

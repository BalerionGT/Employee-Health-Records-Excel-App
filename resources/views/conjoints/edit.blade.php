                        ...
                        <form method="post" action="{{route('conjoints.update',['conjoint'=> $conjoint->id])}}">
                            ...
                            <div class="row d-flex justify-content-center align-items-center">
                                ...
                                <div class="form-group{{ $errors->has('nom') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="nom" id="input-nom" class="form-control form-control-alternative{{ $errors->has('nom') ? ' is-invalid' : '' }}" placeholder="{{ __('Nom') }}" value="{{$conjoint->nom}}" required autofocus>
                                ...
                                <div class="col-4">
                                    <div class="form-group{{ $errors->has('prenom') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="prenom" id="input-prenom" class="form-control form-control-alternative{{ $errors->has('prenom') ? ' is-invalid' : '' }}" placeholder="{{ __('Prénom') }}" value="{{$conjoint->prenom}}" required autofocus>
                            ...
                            <div class="row d-flex justify-content-center align-items-center mt-5">
                                ...
                                <div class="form-group{{ $errors->has('date_naissance') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="date" name="date_naissance" id="input-date_naissance" class="form-control form-control-alternative{{ $errors->has('date_naissance') ? ' is-invalid' : '' }}" placeholder="{{ __('Date de naissance') }}"  value="{{$conjoint->date_naissance}}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('date_debut_adherence') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="date" name="date_debut_adherence" id="input-debut_adherence" class="form-control form-control-alternative{{ $errors->has('date_debut_adherence') ? ' is-invalid' : '' }}" placeholder="{{ __('Date de début d\'adhérence') }}"  value="{{$conjoint->date_debut_adherence}}" required autofocus>
                                ...
                                <div class="col-4">
                                    <div class="form-group{{ $errors->has('date_fin_adherence') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="date" name="date_fin_adherence" id="input-date_fin_adherence" class="form-control form-control-alternative{{ $errors->has('date_fin_adherence') ? ' is-invalid' : '' }}" placeholder="{{ __('Date de fin d\'adhérence') }}" value="{{$conjoint->date_fin_adherence}}" required autofocus>
                            ...
                            <div class="row d-flex justify-content-center align-items-center mt-5">
                                ...
                                <div class="form-group{{ $errors->has('code_assurance') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="code_assurance" id="input-code_assurance" class="form-control form-control-alternative{{ $errors->has('code_assurance') ? ' is-invalid' : '' }}" placeholder="{{ __('Code d\'assurance') }}" value="{{$conjoint->code_assurance}}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('validation') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="validation" id="input-validation" class="form-control form-control-alternative{{ $errors->has('validation') ? ' is-invalid' : '' }}" placeholder="{{ __('validé par assurance') }}" value="{{$conjoint->validation === 1 ? 'Oui':'Non' }}"  required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('affil') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="affil" id="input-affil" class="form-control form-control-alternative{{ $errors->has('affil') ? ' is-invalid' : '' }}" placeholder="{{ __('Affil') }}" value="{{$conjoint->afill === 1 ? 'Oui':'Non' }}" required autofocus>

                        ...
                        <form method="post" action="{{route('users.update',['user' => $user->id])}}">
                            ...
                            <div class="row d-flex justify-content-center align-items-center">
                                ...
                                <div class="form-group{{ $errors->has('matricule') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="matricule" id="input-matricule" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Matricule') }}" value={{$user->matricule}} required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('nom') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="nom" id="input-nom" class="form-control form-control-alternative{{ $errors->has('nom') ? ' is-invalid' : '' }}" placeholder="{{ __('Nom') }}" value={{$user->nom}} required autofocus>
                                ...
                                <div class="col-4">
                                    <div class="form-group{{ $errors->has('prenom') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="prenom" id="input-prenom" class="form-control form-control-alternative{{ $errors->has('prenom') ? ' is-invalid' : '' }}" placeholder="{{ __('Prénom') }}" value={{$user->prenom}} required autofocus>
                            ...
                            <div class="row d-flex justify-content-center align-items-center mt-5">
                                ...
                                <div class="form-group{{ $errors->has('date_naissance') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="date" name="date_naissance" id="input-date_naissance" class="form-control form-control-alternative{{ $errors->has('date_naissance') ? ' is-invalid' : '' }}" placeholder="{{ __('Date de naissance') }}" value={{$user->date_naissance}} required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('date_recrutement') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="date" name="date_recrutement" id="input-date_recrutement" class="form-control form-control-alternative{{ $errors->has('date_recrutement') ? ' is-invalid' : '' }}" placeholder="{{ __('Date de recrutement') }}" value={{$user->date_recrutement}} required autofocus>
                            ...
                            <div class="row d-flex justify-content-center align-items-center mt-5">
                                ...
                                <div class="form-group{{ $errors->has('nbre_enfant') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="nbre_enfant" id="input-nbre_enfant" class="form-control form-control-alternative{{ $errors->has('nbre_enfant') ? ' is-invalid' : '' }}" placeholder="{{ __('Nombre d\'enfant') }}" value={{$user->nbre_enfant}} required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('matricule_conjoint') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="matricule_conjoint" id="input-matricule_conjoint" class="form-control form-control-alternative{{ $errors->has('matricule_conjoint') ? ' is-invalid' : '' }}" placeholder="{{ __('Matricule du conjoint') }}" value={{$user->matricule_conjoint}} required autofocus>
